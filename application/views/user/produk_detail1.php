			...
			<div class="row">
             ...
             <div class="product-big-img">
				        ...
				        <div style="width: 500px;">
					        ...
					        <a href="">
								...
								<?php if ($detail_produk[0]['foto_produk1'] == null) : ?>
									...
									<img src="<?= base_url() ?>assets/img/produk_penjual/<?= $detail_produk[0]['foto_produk1'] ?>" alt="">
				...
				<div class="col-lg-6 product-details">
					<h2 class="p-title"><?= $detail_produk[0]['nama_produk'] ?></h2>
					<h4 class="p-stock">ID: <span><?= $detail_produk[0]['id_produk'] ?></span></h4>
					<h4 class="p-stock">Berat Bersih: <span><?php echo $detail_produk[0]['berat_bersih'] ?> gram</span></h4>
					<h4 class="p-stock">
						<?php if ($detail_produk[0]['jumlah_stok'] > 0) : ?>

                  <p>Stok: <?php echo $detail_produk[0]['jumlah_stok'] ?> items</p>
				  ...
				  <div class="cost" style="margin-top: 20px;">
					...
					<div class="prdt-cost">
							...
							<h3 class="p-title">HARGA PERSATUAN</h3>


							<?php if (isset($detail_produk[0]['harga_promo'])) : ?>

								<h4 class="active">Rp. <s><span id="harga_jual_old"></span></s> <span id="harga_jual"></span></h4>


								<br>
								<h3 class="p-title">SUB TOTAL</h3>


								<h4 class="active">Rp. <span id="subtotal"></span> </h4>

							<?php else : ?>
								<h4 class="active">Rp. <span id="harga_jual"></span> </h4>

								<br>

								<h3 class="p-title">SUBTOTAL</h3>
							...
							<form method="POST" action="<?= base_url() ?>user/Home/keranjang_belanja">
								...
								<div style="display: flex;">
									...
									<input required type="text" class="form-control col-md" id="jumlah_beli" name="jumlah_beli" style="width: 50px; margin: 0 5px; height: 28px; padding: 0 8px; text-align: center; border-radius: 3px;" value="1">
								...
								<?php else : ?>
									...
									<button type="submit" class= "site-btn" id="btn_save" onclick="save()">Tambah ke keranjang</button>
